...
// Map Ports Data (For Searates Style Map)
const mapPortsData = [
  ...
  { id: 7, name: "Long Beach", country: "USA", code: "USLGB", lat: 33.7540, lng: -118.2171, volume: "9.1M TEU" },
  { id: 8, name: "Antwerp", country: "Belgium", code: "BEANR", lat: 51.2640, lng: 4.3980, volume: "12.0M TEU" },
];
  ...
  return (
    <div className="min-h-screen bg-background" role="main">
      ...
      <main id="main-content">
        ...
        {/* ============================================ */}
        {/* NEW SECTION: INTERACTIVE MAP (Searates Style) */}
        {/* ============================================ */}
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 id="map-title" className="text-2xl font-bold flex items-center gap-2">
                    <Globe className="h-6 w-6 text-[#0F4C81]" aria-hidden="true" />
              ...
              <div className="rounded-xl overflow-hidden shadow-2xl border border-border h-[500px] relative">
                      ...
                      <Popup>
                        <div className="p-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-bold text-[#0F4C81]">{port.name}</span>
                          </div>
                ...
                {/* Map Overlay Info */}
                <div className="absolute bottom-4 left-4 z-10 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md p-4 rounded-lg shadow-lg border border-border max-w-xs">
                  <div className="flex items-center gap-2 mb-2">
                    <Ship className="h-4 w-4 text-[#0F4C81]" />
                    <span className="font-semibold text-sm">Top Ports Mapped</span>
                  </div>
                  <p className="text-xs text-muted-foreground mb-2">
                    Click markers to view port details, volume, and transit options.
                  </p>
